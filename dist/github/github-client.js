...
class GitHubClient {
    ...
    isPermissionError(errorMessage) {
        ...
        return permissionIndicators.some(indicator => errorMessage.toLowerCase().includes(indicator.toLowerCase()));
    }
    /**
    ...
    isNonRetryableError(errorMessage) {
        ...
        return nonRetryableIndicators.some(indicator => errorMessage.toLowerCase().includes(indicator.toLowerCase()));
    }
    /**
