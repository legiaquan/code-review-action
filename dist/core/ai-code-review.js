...
class AICodeReview {
    ...
    constructor() {
        ...
        this.prNumber = utils_1.Config.getPullRequestNumber();
        // Initialize services
        this.githubClient = new github_1.GitHubClient(repoInfo);
        this.commentBuilder = new services_1.CommentBuilder(this.config);
        this.errorHandler = new services_1.ErrorHandler(this.githubClient, this.commentBuilder, this.prNumber);
        this.fileProcessor = new services_1.FileProcessor(this.config, this.commentBuilder, this.errorHandler, this.githubClient, this.prNumber);
    }
    /**
